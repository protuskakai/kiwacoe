 ...
 * @author user
 */
public class Loan_Repay_Adjust extends javax.swing.JFrame {
 ...
 int ff=0;
     ...
     */
    public Loan_Repay_Adjust(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30)
                        .addComponent(typ, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
 ...
 public void doread()
{
  ...
  cnt=cnt+1;
            ...
            model.insertRow(p, new Object[]{
                ...
                rs.getString("nam"),
                rs.getString("typ"),
               Format_amt.format(  rs.getString("ramt")),
       //         rs.getString("dur"),
                rs.getString("comm"),
   ...
   //       MessageBox.infoBox("33333", zstat);
            performSave();
     //         MessageBox.infoBox("5555", zstat);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // frame.dispose();
        Loan_Repay_Adjust.this.dispose();
      ...
      }else
          {
            ...
            nam.setText(Find_Loan.znam);
             typ.setText(Find_Loan.ztyp);
              amt.setText(Format_amt.uformat(  Find_Loan.zramtt));
            amt.requestFocus();
            ff=0;
...
public void performSave()
{
     ...
     sql = " update loans set ramtt="+amt.getText().toString() + " where accno="+accno.getText().toString() ;
   ...
   //   msbbox.show(Alert.AlertType.ERROR, sql,"insertrec Method" ,"Database Error");
     ...
     MessageBox.infoBox("Record Update Successfully", "Update");
}
