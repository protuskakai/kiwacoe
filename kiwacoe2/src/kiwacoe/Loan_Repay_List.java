 ...
 * @author user
 */
public class Loan_Repay_List extends javax.swing.JFrame {
DefaultTableModel testlist = new DefaultTableModel();
 ...
 ResultSet rs2 = null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Loan_Repay_Capture dd=new Loan_Repay_Capture(this,true);
          // dd.setModal(true);
    ...
    public void doread()
{
   ...
   // String = mon.getSelectedItem().toString();
    ...
    sql = " select * from repbatches where yr='" + syr + "' and mon='" + smon + "'";
    //    System.
   ...
   public void postbatch(String zyr,String zmon) throws SQLException
{
 ...
 public void readbatch(String hyr,String hmon,ResultSet rrs) throws SQLException {
  ...
  public void update_batch() throws SQLException
  {
      ...
      String sql = "SELECT count(*) as cnt from repayments where CONCAT(yr,mon)='" + syr + smon + "'";
