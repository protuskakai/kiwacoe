 ...
 * @author user
 */
public class LoansNew_Capturexx extends javax.swing.JFrame {
 static ResultSet rs = null;
     ...
     */
    public LoansNew_Capturexx(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
     ...
     try {
         ...
         Logger.getLogger(LoansNew_Capturexx.class.getName()).log(Level.SEVERE, null, ex);
     }
  ...
  try {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // frame.dispose();
        LoansNew_Capturexx.this.dispose();
