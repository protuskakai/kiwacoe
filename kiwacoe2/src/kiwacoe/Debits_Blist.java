...
public class Debits_Blist extends javax.swing.JFrame {
DefaultTableModel testlist = new DefaultTableModel();
 ResultSet rs = null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Debits_capture dd=new Debits_capture(this,true);
          // dd.setModal(true);
              //  dialog.setSize(400, 400);
                dd.setLocationRelativeTo(null);
               // dd.setExtendedState(dd.MAXIMIZED_BOTH);
               dd.setResizable(false);
          dd.setTitle("Debits/Credits Capture");
          dd.setVisible(true);
   ...
   // model.insertRow(p, new Object[] { "r3" });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      //  MessageBox.infoBox("sdffdfsd", "dfdfgg");
        Debits_B_add dd=new Debits_B_add(this,true);
          // dd.setModal(true);
              //  dialog.setSize(400, 400);
                dd.setLocationRelativeTo(null);
               // dd.setExtendedState(dd.MAXIMIZED_BOTH);
               dd.setResizable(false);
          dd.setTitle("Add Debits/Credits Batch");
          dd.setVisible(true);
  ...
  public void dopost() throws SQLException
    {
         String  sql = "SELECT * from debits where yr='" + zyr + "' and mon='" + zmon + "'  and typ='" + ztyp + "' and stat='U'";
        ...
        while (rs22.next()) {
          ...
          //  ktyp = rs22.getString("typ");
            ...
            sql2 = "insert into  caccounts (membid,nam,descr,yr,mon,reg,dat,amt,drcr,pdate,ptime,soc,pseq)"
                    + " values('" + kmembid + "','" + knam + "','"  + kdescr + "','"  + zyr +"','" + zmon + "','Nil','" + kdat + "'," + kamt + ",'" + kdrcr + "',CURDATE(),CURTIME(),'Debit',"+kseq+")";
             System.out.println(sql2);
           //  MessageBox.infoBox(sql2.toString(),"sds");
            insert_rec(sql2);
            sql3="update debits set stat='P',pdate=CURDATE(),ptime=CURTIME() where seq="+kseq;
            System.out.println(sql3);
            update_rec_stat(sql3);
        }
         sql3 = "update drbatches set stat='Posted' where CONCAT(yr,mon,typ)='" + zyr + zmon +  ztyp+"'";
        System.out.println(sql3);
    ...
    public void doread()
{
   // String = mon.getSelectedItem().toString();
    ...
    sql = " select * from drbatches where yr='" + syr + "' and mon='" + smon + "'";
    //    System.
