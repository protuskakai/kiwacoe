 ...
 * @author user
 */
public class Shares_List extends javax.swing.JFrame {
DefaultTableModel testlist = new DefaultTableModel();
 ResultSet rs = null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Shares_Capture dd=new Shares_Capture(this,true);
          // dd.setModal(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        hm.put("yr", zyr);
        hm.put("mon", zmon);
        hm.put("title", "Shares(" +ztyp+ ") :" +GetMonth.format(zmon)+ "  , "+zyr);
              String filename="reportshares2.jrxml";
      String title =  "Shares(" +ztyp+ ") :" +GetMonth.format(zmon)+ "  , "+zyr;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
            ...
            int t = 0;
            try {
                t =Validate_batch.validate(zyr, zmon, "shbatches");
            } catch (SQLException ex) {
                Logger.getLogger(Shares_List.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void doread()
{
   ...
   // String = mon.getSelectedItem().toString();
    ...
    sql = " select * from shbatches where yr='" + syr + "' and mon='" + smon + "'";
    //    System.
         ...
         //   breg = rs.getString("reg");
          btyp = rs.getString("typ");
           ...
           btot = rs.getString("tot");
            ...
            model.insertRow(p, new Object[]{byr, bmon, btyp, brecs, btot, bstat});
