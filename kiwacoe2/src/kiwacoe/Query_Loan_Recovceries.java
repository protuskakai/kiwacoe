 ...
 * @author user
 */
public class Query_Loan_Recovceries extends javax.swing.JFrame {
DefaultTableModel testlist = new DefaultTableModel();
 ...
 ResultSet rs2 = null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        // UsersLisr.e
        Query_Loan_Recovceries.this.dispose();
    ...
    String sval=val.getText().toString();
     ...
     //  double tot=0;
       ...
       switch (fld.getSelectedItem().toString())
       {
             ...
             case "Name":
               sql=" select * from repayments where nam like '%"+sval+"%' order by seq";
               break;   
                case "Member ID":
               sql=" select * from repayments where membid like '%"+sval+"%'   order by seq";
               break;  
           
       }
  //  sql = " select * from repayments where yr='" + zyr + "' and mon='" + zmon + "' order by accno desc";
    //    System.
    ...
    try {
        ...
        while (rs.next()) {
            ...
            double dbal = rs.getDouble("bal");
            bal = Format_amt.format(bal);
            amt = rs.getString("amt");
            double damt = rs.getDouble("amt");
            amt = Format_amt.format(amt);
            intramt = rs.getString("intramt");
            double dintramt = rs.getDouble("intramt");

            intramt = Format_amt.format(intramt);
            ramt = rs.getString("ramt");
            double dramt = rs.getDouble("ramt");
