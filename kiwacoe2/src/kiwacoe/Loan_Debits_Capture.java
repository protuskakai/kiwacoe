 ...
 * @author user
 */
public class Loan_Debits_Capture extends javax.swing.JFrame {
 ...
 int ff=0;
     ...
     */
    public Loan_Debits_Capture(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
        jTable1=SetTable.data(jTable1);
         jButton3.setText("Add");
        zmon = Loan_Debits_List.zmon;
        zyr = Loan_Debits_List.zyr;
    //    ztyp = Expenses_Capture.ztyp;
      //  zreg = Readings_BList.zreg;
        zstat = Loan_Debits_List.zstat;
      doread();
 ...
 public void doread()
{
  ...
  //  String smon = String.format("%02d", mon.getSelectedIndex() + 1);
    ...
    sql = " select * from  loan_adjs where CONCAT( yr,mon)='"+zyr+zmon+"'";
    //    System.
  ...
  try {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // frame.dispose();
        Loan_Debits_Capture.this.dispose();

    }//GEN-LAST:event_jButton4ActionPerformed
public void updatetots()
{
     try {
            String[] qq = BatchTotals.yrmon(zyr, zmon, "adjbatches", "loan_adjs");
...
{
    String        sql = "SELECT * from loan_adjs where yr='" + zyr + "' and mon='" + zmon + "' ";
  //  Connection conn = DBconnect.ConnecrDb();
...
public void performAdd()
{
  ...
  //MessageBox.infoBox(xrdate, "sss");// membid,nam,typ,grp,comm,yr,mon,reg,cread,pread,cdate,ctime                                     
       sql = "insert into  loan_adjs (accno,membid,nam,typ,amt,comm,yr,mon,rdate,cdate,ctime,stat,loanid)"
...
public int cntt() throws SQLException
{
    ...
    String sql = "SELECT count(*) as cnt from loan_adjs where yr='" + zyr + "' and mon='" + zmon + "' ";
  //  Connection conn = DBconnect.ConnecrDb();
    System.out.println(sql);
    pst2 = conn.prepareStatement(sql);
    rs2 = pst2.executeQuery();
