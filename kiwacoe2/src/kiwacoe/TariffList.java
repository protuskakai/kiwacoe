 ...
 * @author user
 */
public class TariffList extends javax.swing.JFrame {
DefaultTableModel testlist = new DefaultTableModel();
 ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        fld.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Category Type" }));
        fld.setToolTipText("");
        ...
        jButton1.setText("Add Category/ Tariff");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
       ...
       switch (sfld)
       {
           case "All":
               ...
               break;
             case "Category Type":
               sql=" select * from tariff where cat like '%"+sval+"%'";
               break;   
   ...
   int p=0;
           while (rs.next())
            {
              //  readdata();
                model.insertRow(p, new Object[] {rs.getString("cat"),rs.getString("rate")});
            }
   ...
   // model.insertRow(p, new Object[] { "r3" });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      //  MessageBox.infoBox("sdffdfsd", "dfdfgg");
        Tarrif_add dd=new Tarrif_add(this,true);
          // dd.setModal(true);
              //  dialog.setSize(400, 400);
                dd.setLocationRelativeTo(null);
               // dd.setExtendedState(dd.MAXIMIZED_BOTH);
               dd.setResizable(false);
          dd.setTitle("Add Category/Tariff");
          dd.setVisible(true);
