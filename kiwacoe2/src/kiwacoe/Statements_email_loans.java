 ...
 * @author user
 */
public class Statements_email_loans extends javax.swing.JFrame {
     HashMap hm = null;
    ResultSet rs = null;
     ...
     */
    public Statements_email_loans(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String xmembid = rs.getString("accno").toString();
                ...
                if (!qmail.equals("n@a.com")) {
                    ...
                    String filename = "reportEmail_loans.jrxml";
                    ...
                    filename2 = "d:\\L" + rs.getString("accno") + ".pdf";
...
public String get_email(String qmembid) throws SQLException
{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Statements_email_loans.this.dispose();
