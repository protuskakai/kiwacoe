 ...
 * @author user
 */
public class Period_add extends javax.swing.JDialog {
     ...
     */
    public Period_add(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        getdata();   
         ...
         try {
             if (Validate_period.exists(xyr, xmon) > 0) {
                 
                 MessageBox.infoBox("Period Exists!!", "Create Period");
                 return;
                 
             }} catch (SQLException ex) {
             Logger.getLogger(Period_add.class.getName()).log(Level.SEVERE, null, ex);
         }
       ...
       // Connection conn = DBconnect.ConnecrDb();
        ...
        sql = "insert into  periods (yr,mon,status,cdate,ctime) values('" + xyr + "','" + xmon + "','Open',CURDATE(),CURTIME())";
        ...
        try {
            ...
            Logger.getLogger(Period_add.class.getName()).log(Level.SEVERE, null, ex);
            MessageBox.infoBox(ex.toString(), "Create Period");
            return;
 ...
 //  msbbox.show(Alert.AlertType.ERROR, "New record saved successfully","New Record" ,"ffff");       
   ...
   //Deposit, Share Capital, Withdrawals, Adjustiments
   
   
  //  sql = "insert into  shbatches (yr,mon,recs,stat,bdate,tot,typ) "
  //                     + "values('"+xyr+"','"+xmon+"',0,'Open',CURDATE(),0,'Deposit')";
  //  execute(sql);
  //   sql = "insert into  shbatches (yr,mon,recs,stat,bdate,tot,typ) "
  //                     + "values('"+xyr+"','"+xmon+"',0,'Open',CURDATE(),0,'Share Capital')";
  //  execute(sql);
         try {
             createbatches();
         } catch (SQLException ex) {
             Logger.getLogger(Period_add.class.getName()).log(Level.SEVERE, null, ex);
             MessageBox.infoBox(ex.toString(), "Create batch error!!");
         }
    
   MessageBox.infoBox("Period Created Successfully", "Create Period");
