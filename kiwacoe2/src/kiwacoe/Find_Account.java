...
public void doread()
{
   ...
   int p=0;
           while (rs.next())
            {
              //  readdata();
                model.insertRow(p, new Object[] {rs.getString("accno"),rs.getString("nam"),rs.getString("grp"),rs.getString("grpnam"),rs.getString("grpaccno")});
...
public void doselect()
{
     int row = jTable1.getSelectedRow();
        if(row<0)
        {
           MessageBox.infoBox("No Record Selected", "Find Account");
           return;
        }
        switch (zfind)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Find_Account.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
