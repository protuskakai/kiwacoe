 ...
 * @author user
 */
public class Expenses_B_Add extends javax.swing.JDialog {
     ...
     */
    public Expenses_B_Add(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void getdata()
{
 ...
 {
     int x = 0;
     String sql = "SELECT yr,mon,COUNT(*) as count FROM expbatches  where yr='" + xyr + "' and mon='" + xmon + "'  group by yr,mon,typ";
