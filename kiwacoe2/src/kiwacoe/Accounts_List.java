 ...
 * @author user
 */
public class Accounts_List extends javax.swing.JFrame {
DefaultTableModel testlist = new DefaultTableModel();
 ...
 int yy=0,r=0;
                     ...
                     //   String mnam = null;
                        ...
                        int[] selectedColumns = jTable1.getSelectedColumns();
	                       ...
	                       int col = 1; // ID is the first Column
                             if(row>-1)
                        {
	                      Accounts_Add.zaccno = jTable1.getValueAt( row, 0 ).toString();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        // zc=row;
        r=1;
        Accounts_Add.pind = "Edit";
        Accounts_Add dd = new Accounts_Add(this,true);
        // dd.setModal(true);
...
public  void doread()
{
    ...
    switch (sfld) {
        case "All":
            sql = " select * from accounts order by accno desc ";
            break;
        case "Name":
            sql = " select * from accounts where nam like '%" + sval + "%'  order by accno desc ";
            break;
        case "Acc No":
            sql = " select * from accounts where accno like '%" + sval + "%' order by accno desc ";
            break;
   ...
   int p=0;
           while (rs.next())
            {
              //  readdata();
                model.insertRow(p, new Object[] {rs.getString("accno"),rs.getString("nam"),rs.getString("grpaccno"),rs.getString("grpnam"),rs.getString("grp")});
                 jTable1.changeSelection(0, 0, false, false);
            }
           
           } catch (SQLException ex) {
        Logger.getLogger(Accounts_List.class.getName()).log(Level.SEVERE, null, ex);
