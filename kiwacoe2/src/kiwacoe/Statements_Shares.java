 ...
 * @author user
 */
public class Statements_Shares extends javax.swing.JFrame {
      HashMap hm =null;
       ResultSet rs = null;
     ...
     */
    public Statements_Shares(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Statements_Shares.this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //  String xtyp = typ.getSelectedItem().toString();
       ...
       // hm.put("typ", xtyp);
        hm.put("title", "Shares Statement  : " +xnam);
        String filename = "reportstatements_shares.jrxml";
        String title = "Shares Statement  : " + xnam ;
