 ...
 * @author user
 */
public class Bills_mails extends javax.swing.JFrame {
     String from = "pkakai@nzoiawater.or.ke";
    final String username = "Protus Kakai";//change accordingly
    final String password = "kakai@2016";//change accordingly
    ...
    String host = "mail.nzoiawater.or.ke";
      HashMap hm =null;
       ResultSet rs = null;
        ...
        public String xyr, xxmon, xmon, xreg,mamt,samt,amt;
        //footer_table
     ...
     */
    public Bills_mails(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Processing......Please Wait!!!");
...
private void addTableHeader2(PdfPTable table) {
 ...
 {
     String mreg=reg.getSelectedItem().toString();
     String  sql = "SELECT * from saccodb where email like '%@%.%' and reg='"+mreg+"' order by membid";
    Connection connz = DBconnect.ConnecrDb();
    System.out.println(sql);
    ...
    rs22 = pst22.executeQuery();
     ...
     while (rs22.next()) {
         ...
         if (t > 0)
         {            
             filename = membid + "_" + xyr + xxmon + ".pdf";
             open_document();
             cnt = cnt + 1;
             makepdf();
             document.close();
          //   MessageBox.infoBox(email, filename);
            dotimer();
             sendemail3(email, filename);
             
             
             knt = knt + 1;
             String sknt = Integer.toString(knt);
             // jLabel4.setText("Processing Record..."+sknt);
         }
        timer.cancel();
      ...
      this.setCursor(Cursor.getDefaultCursor());
       String sknt= Integer.toString(knt);
       MessageBox.infoBox(sknt+" Bills processed!", "Email Bills");
 }
 public void dotimer()
 {
       timer = new Timer();
 ...
 public void test()
 {
   ...
   //  MessageBox.infoBox(filename, filename);
 }
...
public void sendmail()
{
 ...
 String to = "pkakai@nzoiawater.or.ke";
      ...
      javax.mail.Session session = javax.mail.Session.getInstance(props,
         new javax.mail.Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
               return new PasswordAuthentication("pkakai@nzoiawater.or.ke", "kakai@2016");
       }
         });
     ...
     //  message.a
      ...
      //ss.
     // msgbox(Alert.AlertType.INFORMATION,"infoMessage", "titleBar", "headerMessage");
}
public void sendemail3(String to,String filename)
{
    ...
    try {
        ...
        // Set Subject: header field
        message.setSubject("Water Bill for:" + xxmon + " " + xyr);
        ...
        messageBodyPart.setContent("Attached please find your water bill for "+xxmon+ " "+xyr, "text/html");
