 ...
 * @author user
 */
public class Find_Share extends javax.swing.JFrame {
    ...
    public Find_Share() {
        ...
        cellSelectionModel.addListSelectionListener(new ListSelectionListener() {
          ...
          //     ztyp = jTable1.getValueAt(row, 2).toString();
                zramtt = jTable1.getValueAt(row, 2).toString();
                        }
...
public void doread()
{
   ...
   int p=0;
           while (rs.next())
            {
              //  readdata();
                String ramtt=Format_amt.format(rs.getString("samt"));
                model.insertRow(p, new Object[] {rs.getString("membid"),rs.getString("nam"),ramtt});
...
public void doselect()
{
     ...
     int row = jTable1.getSelectedRow();
        if(row<0)
        {
           MessageBox.infoBox("No Record Selected", "Find Share");
           return;
        }
   //     MessageBox.infoBox(zfind, sql);
  /* 
        switch (zfind)
        {
            case "Loan":
