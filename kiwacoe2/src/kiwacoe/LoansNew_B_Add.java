 ...
 * @author user
 */
public class LoansNew_B_Add extends javax.swing.JDialog {
     ...
     */
    public LoansNew_B_Add(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         ...
         System.out.println(sql);
          try {
             ...
             //    rs= pst.executeQuery();
              ...
              MessageBox.infoBox(ex.toString(), "New Loans Batch");
              return;
 ...
 //  msbbox.show(Alert.AlertType.ERROR, "New record saved successfully","New Record" ,"ffff");       
   ...
   MessageBox.infoBox("Batch Created Successfully", "New Loans Batch");
    ...
    public void getdata()
{
 ...
 {
     int x = 0;
     String sql = "SELECT yr,mon,typ,COUNT(*) as count FROM nwlbatches  where yr='" + xyr + "' and mon='" + xmon + "' and typ='" + xtyp + "'  group by yr,mon,typ";
