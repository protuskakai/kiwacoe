 ...
 * @author user
 */
public class Balances_Loans extends javax.swing.JFrame {
      HashMap hm =null;
       ResultSet rs = null;
     ...
     */
    public Balances_Loans(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
   ...
   /*       
       //   sql = "create or replace view mm as select accno,nam,typ,sum(dr-cr) as obal,sum(0) as paid,sum(0) as iamt  from  sumbals  where  CONCAT(yr,mon)<'" + xyr + xmon + "' group by accno,nam,typ   union select accno,nam,typ,sum(0) as obal,sum(amt) as paid,sum(0) as iamt  from  repayments  where  CONCAT(yr,mon)='" + xyr + xmon + "' group by accno,nam,typ union select accno,nam,typ,sum(0) as obal,sum(0) as paid,sum(intr) as iamt  from  mbals  where  CONCAT(yr,mon)='" + xyr + xmon + "' group by accno,nam,typ";
...
*/
       ...
       System.out.println(xyr+" "+xmon+ " ");
        ...
        hm.put("mon", xmon);
          hm.put("yr", xyr);
        hm.put("title", "Loan Balances : " + xxmon + "  , " + xyr);
        String filename = "reportbalances.jrxml";
        String title = "Loan Balances : " + xxmon + "  , " + xyr;
