...
public class TB extends javax.swing.JFrame {
     ...
     */
    public TB(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
     ...
     String xmon = String.format("%02d", mon.getSelectedIndex() );  
      this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
       ...
       System.out.println(xyr+" "+xmon+ " ");
        ...
        hm.put("mon", xmon);
          hm.put("yr", xyr);
        hm.put("title", "Trial Balance For " + xxmon + "  , " + xyr);
        String filename = "reportTB.jrxml";
        String title = "Trial Balance For " + xxmon + "  , " + xyr;
