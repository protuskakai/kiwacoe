...
public void doread()
{
    ...
    switch (sfld) {
        case "All":
            ...
            break;
        case "Name":
            sql = " select * from  loans where nam like '%" + sval + "%'";
            break;
        case "Acc No":
            sql = " select * from  loans where  accno like '%" + sval + "%'";
            break;
   ...
   int p=0;
           while (rs.next())
            {
              //  readdata();
                model.insertRow(p, new Object[] {rs.getString("accno"),rs.getString("nam"),rs.getString("typ"),
