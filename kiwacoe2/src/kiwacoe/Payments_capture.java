 ...
 * @author user
 */
public class Payments_capture extends javax.swing.JFrame {
 static ResultSet rs = null;
     ...
     */
    public Payments_capture(java.awt.Frame parent, boolean modal) {
       // super(parent, modal);
        initComponents();
         jButton3.setText("Add");
        zmon = Payments_BList.zmon;
        zyr = Payments_BList.zyr;
        ztyp = Payments_BList.ztyp;
      //  zreg = Readings_BList.zreg;
        zstat = Payments_BList.zstat;
...
{
    String        sql = "SELECT * from payments where yr='" + zyr + "' and mon='" + zmon + "' and typ='" + ztyp + "'";
  //  Connection conn = DBconnect.ConnecrDb();
...
public void performAdd()
{
  ...
  MessageBox.infoBox(xrdate, "sss");// membid,nam,typ,grp,comm,yr,mon,reg,cread,pread,cdate,ctime                                     
       sql = "insert into  payments (membid,nam,typ,amt,comm,yr,mon,rdate,cdate,ctime,stat)"
 ...
 public void poputate_fields() {
     //   Connection conn = DBconnect.ConnecrDb();
        ...
        sql = "SELECT * from payments where yr='" + zyr + "' and mon='" + zmon  + "' and typ='" + ztyp + "'";
